  ...
  return (
    <main className="park-page">
      ...
      <section className="presentation-container">
        ...
        <h1 className="park-subtitle">Bienvenue à ZombieLand !</h1>
        <h3 className="park-highlight">Plongez dans l’Apocalypse et Déclenchez l’Adrénaline</h3>
        ...
        <h2 className="park-section-title">Ce qui vous attend :</h2>

        <h3 className="park-highlight">Attractions Époustouflantes</h3>
        <p className="park-text">
        ...
        <h3 className="park-highlight"><strong>Spectacles Horrifiques</strong></h3>
        ...
        <h3 className="park-highlight">Réservez Votre Aventure !</h3>
        ...
        <h3 className="park-highlight">Soyez Prêt Pour l’Inattendu !</h3>
        ...
        <p className="park-text"><strong>Oserez-vous franchir les portes de ZombieLand ?</strong></p>
        ...
        <h3 className="park-highlight">Contact & Informations</h3>
      ...
      {/* Informations pratiques et tarifs */}
            <div className="park-right">
                    <section className="park-infos">
                        ...
                        <h2 className="park-section-title">Tarifs</h2>
                        {tickets.map((ticket) => (
                        ...
                        <h2 className="park-section-title">Horaires d'ouverture</h2>
